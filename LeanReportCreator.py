    ...
    def drawdown(self,name = "drawdowns.png",width = 11.5, height = 2.5):
        if self.is_drawable:
            ...
            for i in range(min(len(tmp_df),5)):
                ...
                plt.axvline(tmp_mid, 0,0.95, ls = "dashed",color ="grey", zorder = 4, linewidth = 0.75)
...
#Usage
lrc = LeanReportCreator("C:/Users/Jack Simonson/36546c701c0d07496c8f7160a7298b68.json")
lrc.genearte_report()
